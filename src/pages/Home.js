const Home = ({ history }) => {
  ...
  return (
    <div className='relative h-screen bg-black border-b-8 border-gray-700 bg-card-image bg-center'>
      ...
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-3/4 text-white z-20 text-xl flex flex-col justify-center items-center text-center'>
